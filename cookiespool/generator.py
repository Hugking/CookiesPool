...
from login.pdsu.cookies1 import PdsuCookies
...
class PdsuCookiesGenerator(CookiesGenerator):
    def __init__(self, website='pdsu'):
        """
        初始化操作
        :param website: 站点名称
        :param browser: 使用的浏览器
    ...
    def new_cookies(self, username, password):
        ...
        :return: 用户名和Cookies
        """
        return PdsuCookies(username, password, self.browser).main()


if __name__ == '__main__':
    generator = PdsuCookiesGenerator()
    generator.run()
